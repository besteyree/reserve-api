...
Route::group(['middleware' => 'auth:sanctum'], function () {
  ...
  Route::post('restaurant_statistics/{id?}', [RestaurantStatisticsController::class, 'restaurant_statistics']);
  ...
  Route::post('getvendor_reservation', [ReservationController::class, 'getvendor_reservation']);
});
