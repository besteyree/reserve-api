    ...
    <div style="max-width: 600px; margin: 0 auto;" class="email-container">
      ...
      <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
          ...
          <td class="bg_white logo" style="padding: 1em 2.5em; text-align: center">
            <h1><a href="#">Shakes bierre</a></h1>
          </td>
	      </tr><!-- end tr -->
				<tr>
          <td valign="middle" class="hero" style="background: black;; background-size: cover; height: 400px;">
            <table>
            	<tr>
            		<td>
            			<div class="text" style="padding: 0 3em; text-align: center;">
            				<h2>We Serve Healthy &amp; Delicious Foods</h2>
            				<p>Hi, {{ $name }} <br> Thank You, We have confirmed your Reservation! See you 😊</p>
            				<p><a href="http://127.0.0.1:3000?user={{$disruptedEmailAddress}}" class="btn btn-primary">See Your Reservation Detail!</a></p>
            			</div>
            		</td>
            	</tr>
            </table>
		          ...
		          <tr>
		            <td class="bg_dark email-section" style="text-align:center;">
		            	<div class="heading-section heading-section-white">
		              	...
		              	<h2>Welcome To Shakeshbierre</h2>
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: left; padding-right: 10px;">
                      	<h3 class="heading">Shakeshbierre</h3>
                      	<p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
                      </td>
                    </tr>
                  </table>
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: left; padding-left: 5px; padding-right: 5px;">
                      	...
                      	<ul>
					                <li><span class="text">MG Road, Banglore</span></li>
        	...
        	<td valign="middle" class="bg_black footer email-section">
                ...
                <td valign="top" width="33.333%">
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: left; padding-right: 10px;">
                      	<p>&copy; 2021 Shakeshbierre. All Rights Reserved</p>
                      </td>
                    </tr>
                  </table>
                </td>
